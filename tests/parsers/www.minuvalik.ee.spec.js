...
var expect = require('chai').expect,
  ...
  fs = require("fs"),
  MinuvalikParser = require('../../apps/parsers/www.minuvalik.ee.js');

var urls = {
  'offer': {
    'est': 'https://www.minuvalik.ee/ee/deal/0864319655/',
    'rus': 'https://www.minuvalik.ee/ru/deal/0864319655/'
  }
};

var parser = new MinuvalikParser();
