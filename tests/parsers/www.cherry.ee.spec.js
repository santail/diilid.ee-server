...
var expect = require('chai').expect,
  ...
  fs = require("fs"),
  CherryParser = require('../../apps/parsers/www.cherry.ee.js');

var urls = {
  'offer': {
    'est': 'https://cherry.ee/16-osaline-sushikomplekt',
    'rus': 'https://cherry.ee/ru/16-osaline-sushikomplekt'
  }
};

var parser = new CherryParser();
