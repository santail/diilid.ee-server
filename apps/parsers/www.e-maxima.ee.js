  ...
  var config = {
    ...
    'templates': {
      ...
      'original_price': function ($) {
        return that.priceCleanup($('#ctl00_MainContent_productDetails_campaignInDetailsTop_labelOldPrice, #ctl00_MainContent_prodDetails_campaignInDetailsTop_labelOldPrice').text());
      },
      'price': function ($) {
        return that.priceCleanup($('#ctl00_MainContent_productDetails_campaignInDetailsTop_labelNewPrice, #ctl00_MainContent_prodDetails_campaignInDetailsTop_labelNewPrice').text());
      },
