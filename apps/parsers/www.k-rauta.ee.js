...
function KRautoParser() {
  ...
  this.config = {
    ...
    'templates': {
      ...
      'price': function ($) {
        return utils.unleakString($('#product-options div.price-options span.price.show-vat').text().trim());
      },
      'original_price': function ($) {
        return $('#product-options div.price-options span.old_price span.old_price_price.show-vat').text().trim();
      },
      'period': function ($) {
